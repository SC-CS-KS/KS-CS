...
## [VC(Version Control)](KS-Programme-Tools/VC/README.md)
### [Git](KS-Programme-Tools/VC/Git/README.md)

# [DataBase](https://github.com/SunnnyChan/KS-DataBase)
## SQL
## [MySQL](https://github.com/SunnnyChan/KS-DataBase/KS-MySQL)
## [Redis](https://github.com/SunnnyChan/KS-DataBase/KS-Redis)
## HBase
...
# 基础设施
## [Cache（缓存）](https://github.com/SunnnyChan/KS-Architect/z_Infra/KS-Cache)
## [MQ （消息队列）](https://github.com/SunnnyChan/KS-Architect/z_Infra/KS-MQ)
## [Service Governance（服务治理）](https://github.com/SunnnyChan/KS-Architect/z_Infra/KS-ServiceGovernance)
## 容器
## 调研链
...
# [Software Engineering （软件工程）](https://github.com/SunnnyChan/KS-SE)
## 软件设计与建模
### [DDD](https://github.com/SunnnyChan/KS-DDD)
## 软件质量改进 (Software Improve)
## 软件开发实践
## 软件行业定律
## 软件开发规范

# [QA 质量保证](https://github.com/SunnnyChan/KS-QA)
## SQA （软件质量保证）
## 测试
### APIs Test （接口测试）
### Unit Test （单元测试）
